...
public class FZViewed {
    ...
    public FZViewed(double x, double a, double b, double waight) {
        this.x = x;
        this.a = a;
        this.b = b;
        this.waight = waight;
    ...
    {
        return 1 - 2 * Math.pow((this.x - this.a) / (this.b - this.a), 2);
    }

    private double thirdCase() // if b<x
    {
        return 2 * Math.pow((this.b - this.x) / (this.b - this.a), 2);
    }
